...
echo "executing bwa aln $REERENCE_SEQUENCE $READ1_FASTQ"

#This aligns the first read to the genome
bwa aln -t 6 $REERENCE_SEQUENCE $READ1_FASTQ > ${OUTPUT_NAME}_1.sai
echo "executing bwa aln $REERENCE_SEQUENCE $READ2_FASTQ"

#This aligns the second read to the genome
bwa aln -t 6 $REERENCE_SEQUENCE $READ2_FASTQ > ${OUTPUT_NAME}_2.sai
