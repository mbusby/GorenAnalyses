...
echo InputBam $INPUT_BAM
echo OutputDir $OUTPUT_DIR
echo control $CONTROL
echo Peak style $PEAK_STYLE 
echo Genome File $GENOME_FILE
echo paird end $PAIRED_END
...
then
	...
	findPeaks $OUTPUT_DIR/Tags/$STEM -style $PEAK_STYLE -o $OUTPUT_DIR/Peaks/param2.$STEM.calls 	

else


echo "findPeaks $OUTPUT_DIR/$STEM region -size 1000 -o $OUTPUT_DIR/Peaks/$STEM.calls -i $CONTROL_DIR"
	findPeaks $OUTPUT_DIR/Tags/$STEM -region -size 1000 -o $OUTPUT_DIR/Peaks/param5.$STEM.calls -i $CONTROL_DIR
